package com.fox.expenseincomemanage.filter;


import com.fox.expenseincomemanage.constant.CommonConstants;
...
import com.fox.expenseincomemanage.util.CipherUtils;
import com.fox.expenseincomemanage.util.RedisCacheUtils;
import com.fox.expenseincomemanage.constant.RedisConstants;
import com.fox.expenseincomemanage.util.WaveStrUtils;
import com.fox.expenseincomemanage.util.WebUtils;
...
public class AuthenticationTokenFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        RedisUser redisUser;
        // 如果是普通用户
        redisUser = redisCacheUtils.getCacheObject(RedisConstants.LOGIN_USER_INFO_KEY + info[0]);
